...
-- Returns the smart root directory based on opened buffer.
-- The root directory will be returned in follow order.
...
---@return string
function M.get_root()
  --Get the full path for the current opened buffer.
  ---@type string
  local file_name = vim.api.nvim_buf_get_name(0)
  local path = file_name ~= "" and vim.loop.fs_realpath(file_name) or nil
